...
type AgentsListSectionProps = {
  loadingAgents: boolean
  agents: Agent[]
}

export default function AgentsListSection({ loadingAgents, agents }: AgentsListSectionProps) {
  return (
    <section className="rounded-2xl w-full border border-slate-300 bg-white backdrop-blur-2xl p-6 dark:border-slate-600 dark:bg-slate-800">
      <div className="mb-4">
        <h1 className="text-2xl font-semibold text-slate-900 dark:text-white">Existing Intern Agents</h1>
      </div>
